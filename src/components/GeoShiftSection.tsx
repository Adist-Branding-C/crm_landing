  ...
  return (
    <div className="flex-1 bg-[#343434] py-[120px] px-8 flex flex-col items-center gap-8 text-center rounded-2xl">
      <h2 className="font-heading text-[28px] md:text-[36px] font-medium leading-[46px] tracking-[-0.72px] text-white max-w-[500px]">
        Your leads aren&apos;t waiting around. The first business to follow up
      ...
      <p className="text-lg text-white max-w-[440px]">
        See how Leadist keeps every lead moving forward, from first contact
        to closed deal.
      </p>
      <a
        href="#"
        className="flex h-11 items-center justify-center rounded-md bg-white px-8 text-sm font-medium text-[#1a1a1a]"
      >
        Book a Free Demo
      </a>
    </div>
